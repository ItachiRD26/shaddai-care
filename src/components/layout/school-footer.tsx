        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="text-2xl font-black text-white">SHADDAI SCHOOL</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#programa" className="text-slate-300 hover:text-white transition-colors">
                  Programa
                </Link>
              </li>
              <li>
                <Link href="#admisiones" className="text-slate-300 hover:text-white transition-colors">
                  Admisiones
                </Link>
              </li>
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Contacto</h3>
            <ul className="space-y-3 text-slate-300">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:contacto@shaddaischool.edu.do" className="hover:text-white">
                  contacto@shaddaischool.edu.do
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-slate-400 mt-1 flex-shrink-0" />
                <a href="tel:+18091234567" className="hover:text-white">
                  (809) 123-4567
                </a>
              </li>
            </ul>
