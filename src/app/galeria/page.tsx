...
// Hook simple para animaciones al entrar en viewport
...
export default function GaleriaPage() {
  ...
  const galleryItems: Array<{
    ...
    { id: 1, type: "image", src: "/images/galeria-1.webp", title: "Hora del Cuento Mágico", category: "actividades", description: "Los niños disfrutando de cuentos mágicos que despiertan su imaginación", featured: true, size: "large" },
    { id: 2, type: "image", src: "/images/galeria-2.webp", title: "Aula Principal Renovada", category: "instalaciones", description: "Espacios modernos diseñados especialmente para el aprendizaje integral", size: "medium" },
    { id: 3, type: "video", src: "/images/galeria-3.webp", title: "Día de Graduación 2024", category: "eventos", description: "Celebrando los logros y el crecimiento de nuestros pequeños graduados", featured: true, size: "large" },
    { id: 4, type: "image", src: "/images/galeria-4.webp", title: "Taller de Pintura Creativa", category: "arte", description: "Expresando creatividad y emociones a través de colores vibrantes", size: "small" },
    { id: 5, type: "image", src: "/images/galeria-5.webp", title: "Recreo Divertido", category: "actividades", description: "Momentos de diversión y socialización al aire libre", size: "medium" },
    { id: 6, type: "image", src: "/images/galeria-6.webp", title: "Biblioteca Infantil", category: "instalaciones", description: "Un rincón mágico dedicado al amor por la lectura", size: "small" },
    { id: 7, type: "image", src: "/images/galeria-7.webp", title: "Festival de Primavera", category: "eventos", description: "Celebrando la llegada de la primavera con alegría y color", featured: true, size: "large" },
    { id: 8, type: "image", src: "/images/galeria-8.webp", title: "Manualidades Navideñas", category: "arte", description: "Creando decoraciones especiales llenas de amor y creatividad", size: "medium" },
    { id: 9, type: "image", src: "/images/galeria-9.webp", title: "Clase de Música", category: "actividades", description: "Descubriendo el maravilloso mundo de los sonidos y ritmos", size: "small" },
    { id: 10, type: "image", src: "/images/galeria-10.webp", title: "Área de Juegos Segura", category: "instalaciones", description: "Diversión segura y supervisada para todos nuestros pequeños", size: "medium" },
    { id: 11, type: "image", src: "/images/galeria-11.webp", title: "Obra de Teatro Infantil", category: "eventos", description: "Pequeños artistas brillando en el escenario con sus talentos", size: "large" },
    { id: 12, type: "image", src: "/images/galeria-12.webp", title: "Escultura en Plastilina", category: "arte", description: "Moldeando la imaginación con sus propias manos creativas", size: "small" },
  ]
  ...
  const prevImage = () => {
    if (selectedIndex !== null) setSelectedIndex(selectedIndex === 0 ? filteredItems.length - 1 : selectedIndex - 1)
  }
  ...
  // Bloquear scroll de body cuando el modal esté abierto (mejor UX en móvil)
  useEffect(() => {
      ...
      <main className="min-h-screen bg-white">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <Camera className="absolute top-1/4 right-1/4 w-8 h-8 text-white/20 animate-spin" style={{ animationDuration: "8s" }} />
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
            <div className={`transition-all duration-1000 ${heroRef.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
              ...
              <p className="text-xl lg:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-medium mb-8">
                Descubre los momentos más especiales, las sonrisas más brillantes y los recuerdos más preciados de nuestra familia Shaddai ✨
              </p>
            </div>
          </div>
        </section>

        {/* Stats Section (se mantiene el estilo amarillo) */}
        <section
          ref={statsRef.ref as any}
          className={`py-16 bg-gradient-to-r from-yellow-50 to-yellow-100 transition-all duration-1000 ${statsRef.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 mb-8">
              ...
              <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
                <button
                  ...
                  className={`px-4 py-2 rounded-md transition-all duration-300 ${viewMode === "masonry" ? "bg-yellow-500 text-white shadow-sm" : "text-gray-600 hover:text-gray-900"}`}
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md transition-all duration-300 ${viewMode === "grid" ? "bg-yellow-500 text-white shadow-sm" : "text-gray-600 hover:text-gray-900"}`}
              ...
              {categories.map((category) => {
                ...
                return (
                  ...
                  >
                    ...
                    {category.name}
                    <span className={`${activeCategory === category.id ? "bg-white/20" : "bg-gray-100"} px-2 py-1 rounded-full text-xs`}>{category.count}</span>
                  </button>
                )
              })}
            </div>
        ...
        <section
          ...
          className={`py-20 bg-gradient-to-br from-yellow-50/30 to-yellow-100/30 transition-all duration-1000 ${galleryRef.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
              ...
              {filteredItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden h-full">
                    <Image
                      src={item.src || "/placeholder.svg?height=400&width=600&query=imagen%20galeria%20infantil"}
                      alt={item.title}
                      width={600}
                      height={400}
        ...
        {/* Lightbox Modal: cerrar al hacer clic fuera, ESC, flechas y swipe */}
        {selectedIndex !== null && (
          <div
          ...
          >
            ...
            >
              {/* Close Button (opcional; también se cierra haciendo clic fuera) */}
              <button
                onClick={() => setSelectedIndex(null)}
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-2xl">
                <div className="relative flex items-center justify-center bg-black">
                  <Image
                    src={filteredItems[selectedIndex].src || "/placeholder.svg?height=600&width=1000&query=imagen%20ampliada%20galeria"}
                ...
                <div className="p-6 sm:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    ...
                    <div className="text-gray-500 text-sm">
                      <span className="sr-only">Posición en la galería: </span>
        ...
        <section
          ...
          className={`py-24 bg-gradient-to-r from-yellow-500 to-yellow-400 text-white relative overflow-hidden transition-all duration-1000 ${ctaRef.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Cada día creamos nuevos recuerdos llenos de alegría, aprendizaje y amor. Tu pequeño puede ser el protagonista de la próxima historia.
            </p>
